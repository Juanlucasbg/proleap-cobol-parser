...
SaleADS Playwright automation
-----------------------------

This repository also includes a standalone Playwright E2E test for the SaleADS
"Mi Negocio" workflow:

* Test file: `tests/saleads_mi_negocio_full_test.spec.js`
* Config file: `playwright.config.js`

The test is environment-agnostic and does not hardcode a domain. Provide the
current environment login URL at runtime.

```bash
SALEADS_LOGIN_URL="https://<current-env>/login" npm run test:e2e:saleads
```
...
Evidence generated by the test:

* checkpoint screenshots (Playwright test output folder)
* final JSON report at `artifacts/saleads/saleads_mi_negocio_full_test_report.json`
